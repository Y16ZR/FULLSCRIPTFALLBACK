...
echo -e "  \e[0;34m┃$NC$green[${white}11${green}] ${white}DOMAIN CLOUDFLARE         \e[0;34m┃$NC    VMESS WS $green     =$NC $yellow$JUMLAHVMESSWS     \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}12${green}] ${white}BACKUP/RESTORE SERVER     \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}13${green}] ${white}ADD/CHANGE DOMAIN SERVER  \e[0;34m┃$NC    VlESS WS $green     =$NC $yellow$JUMLAHVLESSWS     \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}14${green}] ${white}ADD/CHANGE NS(SLOW DNS)   \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}15${green}] ${white}RENEW CERTIFICATE XRAY    \e[0;34m┃$NC    VlESS XTLS $green   =$NC $yellow$JUMLAHVLESSXTLS     \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}16${green}] ${white}SHOW ALL PORT VPN         \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}17${green}] ${white}CHANGE PORT VPN           \e[0;34m┃$NC    TROJAN WS $green    =$NC $yellow$JUMLAHTROJANWS     \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}18${green}] ${white}SHOW RUNNING SCRIPT       \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}19${green}] ${white}CLEAR-LOG & CACHE         \e[0;34m┃$NC    TROJAN GRPC $green  =$NC $yellow$JUMLAHTROJANGRPC     \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}20${green}] ${white}SHOW SERVER BANDWITH      \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}21${green}] ${white}CHANGE PASSWORD VPS       \e[0;34m┃$NC    WIREGUARD $green    =$NC $yellow$JUMLAHWG     \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}22${green}] ${white}SHOW SPEEDTEST SERVER     \e[0;34m┃$NC                          \e[0;34m┃$NC"
echo -e "  \e[0;34m┃$NC$green[${white}23${green}] ${white}UPDATE PREMIUM SCRIPT     \e[0;34m┃$NC    SHADOWSOCKS $green  =$NC $yellow$JUMLAHSS     \e[0;34m┃$NC"
